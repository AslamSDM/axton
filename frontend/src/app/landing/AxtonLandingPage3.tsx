...
const imgWhatsAppImage20251008At1630064Aed90101 =
  "https://www.figma.com/api/mcp/asset/b527f3a2-24cb-4679-82a9-33850c954697";
const imgTexture =
  "https://www.figma.com/api/mcp/asset/88261558-f306-4aef-9abf-bf7c69423c73";
const imgVector15 =
  "https://www.figma.com/api/mcp/asset/976a60ae-0e5d-4878-ab0e-d6accb689403";
const imgGroup56 =
  "https://www.figma.com/api/mcp/asset/65c7c61f-947f-4c79-855f-d611fa40c27d";
const imgLine18 =
  "https://www.figma.com/api/mcp/asset/8ab9162f-1922-446b-a86c-dc012f33369d";

export default function AxtonLandingPage3() {
  return (
    <section className="bg-[#0b0b0d] relative w-full min-h-screen overflow-hidden">
      ...
      <main className="relative z-10 px-[56px] pt-[35px]">
        ...
        <div className="relative flex gap-8 justify-center items-start px-[64px] mb-8">
          {/* Card 1 - ROI Income */}
        ...
        <div className="absolute backdrop-blur-[2px] bg-gradient-to-r from-[rgba(52,113,192,0.7)] to-[rgba(46,246,141,0.7)] blur-[26.5px] h-[218px] left-0 mix-blend-color-dodge w-full bottom-0" />
      </main>
    </section>
  );
}
