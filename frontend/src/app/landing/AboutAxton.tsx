      ...
      <div className="fixed top-20 left-0 w-full h-screen pointer-events-none z-10">
        ...
        >
          <motion.h2
            ...
            className="font-['Space_Mono',monospace] font-bold text-white tracking-[-2.25px] leading-tight"
          >
        ...
        >
          ...
          <motion.div className="font-['Space_Mono',monospace] text-[14px] text-white tracking-[-0.7px] max-w-[1084px] mb-16">
            <p className="mb-4">
          ...
          <motion.div className="relative flex items-center justify-center gap-3 mb-8">
            {/* Left card */}
          ...
          <motion.div className="bg-gradient-to-r from-[#2ef68d] to-[#478ff5] h-[3px] w-[470px] mx-auto" />
        </motion.div>
      </div>
    </section>
  );
