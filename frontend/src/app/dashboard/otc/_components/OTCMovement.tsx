...
const mockOtcMovementData: OtcMovementData[] = [
  ...
  },
  {
    ...
    fromWallet: "EX9B2C...4D1E",
    toWallet: "EX6F7A...8E9B",
    amount: "450 BNB",
    exchange: "BINANCE",
    tradeType: "SELL",
    tx: "Oxdef456",
  ...
  },
  {
    ...
    fromWallet: "EX1C2D...3E4F",
    toWallet: "EX5G6H...7I8J",
    amount: "12000 ADA",
    exchange: "KRAKEN",
    tradeType: "BUY",
    tx: "Oxghi789",
  ...
  },
  {
    ...
    fromWallet: "EX2D3E...4F5G",
    toWallet: "EX6H7I...8J9K",
    amount: "850 DOT",
    exchange: "COINDCX",
    tradeType: "SWAP",
    tx: "Oxjkl012",
  ...
  },
  {
    ...
    fromWallet: "EX3E4F...5G6H",
    toWallet: "EX7I8J...9K0L",
    amount: "25000 MATIC",
    exchange: "BINANCE",
    tradeType: "BUY",
    tx: "Oxmno345",
...
export function OTCMovementTable(): React.ReactElement {
  ...
  const handleSeeAll = () => {
    checkBalanceAndProceed(() => {
      ...
      toast.success(isExpanded ? "Table Collapsed" : "Showing All Movements", {
        description: isExpanded
          ? "Showing recent movements only"
          : `Displaying all ${mockOtcMovementData.length} OTC movements`,
      });
    });
  };
            ...
            <TableBody>
              {displayedData.map((item) => (
                ...
                >
                  ...
                  <TableCell>
                    <WalletAddress address={item.fromWallet} />
                  </TableCell>
                  <TableCell>
                    <WalletAddress address={item.toWallet} />
                  </TableCell>
